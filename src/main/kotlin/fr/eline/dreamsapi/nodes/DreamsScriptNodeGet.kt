...
class DreamsScriptNodeGet(override val uid: UUID,
                          ...
                          override val args_out: ArrayList<UUID>) : DreamsScriptNode(uid, DreamsScriptNodeType.Get.typeName, flags, next_nodes, args_in, args_out){

    constructor(param_name: String, flags: String, next_nodes: ArrayList<UUID>, args_in: ArrayList<UUID>, args_out: ArrayList<UUID>) : this(UUID.randomUUID(), param_name, flags, next_nodes, args_in, args_out)
